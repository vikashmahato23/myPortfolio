...
//     window.open('https://github.com/vikashmahato23');
// }

// function linkedin(){
    
//     window.open('https://www.linkedin.com/in/vikashmahato/');
// }
// function twitter(){
...
// function phone(){
//     document.getElementById('show-social').innerText = "+917488027671"
// }
...
function showResume(){
    ...
    window.open('https://drive.google.com/file/d/187DnpGlM0G4sIbHH8S66qf868II7wJJd/view?usp=sharing');
  }
  ...
  function githubDunzo(){
    window.open('https://github.com/sssrikanthhh/faasos.git')
  }
  
  function githubDerm(){
    window.open('https://github.com/Hashmat-Noorani/Kohl-s.git')
  }
  
  function liveDerm(){
    window.open('https://hashmat-noorani.github.io/Kohl-s/#')
  }
  
  function liveDunzo(){
    window.open('https://hungry-engelbart-9a3206.netlify.app/')
  }
